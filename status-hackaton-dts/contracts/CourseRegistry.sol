...
contract CourseRegistry {
    ...
    //* Public functions    
    //*
    function registerCourse(address _studentAddress, uint _startDateTime, uint _endDateTime, uint _amount) {
        
        // Build the contract
        address courseAddress = new Course(this, _studentAddress, msg.sender, _startDateTime, _endDateTime, _amount);
