...
contract Course is Ownable{
    ...
    //* Constructor    
    //*
    function Course(address _registry, address _studentAddress, address _teacherAddress, uint _startDateTime, uint _endDateTime, uint _amount) {  
        registry        = _registry;
    ...
    //* Getter   
    //*
    function getCourseDetails() constant returns  (address _studentAddress, address _teacherAddress, uint _startDateTime, uint _endDateTime, uint _amount, Common.State) {
    
        return (studentAddress, teacherAddress, startDateTime, endDateTime, amount, state); 
    }
    //***********************/
