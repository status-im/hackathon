...
export class ContractService {
    ...
    public registerCourse (studentAddress, startDate, endDate, amount) {
        var self = this;
        ...
        return new Promise(function(resolve, reject) {
            ...
            self.http.get("contracts/CourseRegistry.json").subscribe(data => {
                self.courseRegistryContract.deployed().then(function(instance) {
                    return instance.registerCourse(studentAddress, startDate / 1000, endDate / 1000, self.web3.toWei(amount, "ether"), {from: self.account, gas: 4000000})
